export class Atelier {
  ...
  static backup = new Atelier(0, `
    ...
    <br/>
    <b>EXHIBIT Arhitectura</b> was founded in 2007. Our team has designed and accompanied throughout the execution a wide range of constructions and developments for clients such as: Quin Auto¬motive, Total Romania, Electroprecizia Logistic Park, GlaxoSmithKline / Europharm, Brasov Maternity, INAR, Alpla Romania / Star East Pet, Brasov City hall, Velux Romania, Temad , Eldon, Auchan, LBBW Immobilien/Dootzdevelopment, Humanitas Bookstores Retail<br/>
    <br/>
